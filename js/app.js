(function () {
  ...
  var T = {
    es: {
      ...
      authGoogleText: 'Usá tu cuenta Google. Después configuramos tu PIN de conductor.',
      authGoogleBtn: 'Continuar con Google',
      authRegisterTitle: 'Completá tus datos',
      authRegisterText: 'Nombre y celular. El admin te asigna un PIN y te activa.',
      ...
      adminIntro: 'Conductores activos. El PIN no se muestra acá; regenerarlo se revela al conductor al próximo ingreso.',
      adminExit: 'Salir',
    ...
    en: {
      ...
      authGoogleText: 'Use your Google account. Then we set up your driver PIN.',
      authGoogleBtn: 'Continue with Google',
      authRegisterTitle: 'Complete your details',
      authRegisterText: 'Name and phone. The admin assigns a PIN and activates you.',
      ...
      adminIntro: 'Active drivers. The PIN is not shown here; regenerating it reveals the new PIN to the driver on next login.',
      adminExit: 'Exit',
    ...
    pt: {
      ...
      authGoogleText: 'Use sua conta Google. Depois configuramos seu PIN de motorista.',
      authGoogleBtn: 'Continuar com Google',
      authRegisterTitle: 'Complete seus dados',
      authRegisterText: 'Nome e celular. O admin atribui um PIN e ativa você.',
      ...
      adminIntro: 'Motoristas ativos. O PIN não aparece aqui; regenerá-lo revela o novo PIN ao motorista no próximo acesso.',
      adminExit: 'Sair',
